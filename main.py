...
table = pygame.image.load("images - Copy/table.jpg").convert_alpha()
table = pygame.transform.smoothscale(table, (1050, 1050))

hit = pygame.image.load("images - Copy/hit-hand-signal.gif").convert_alpha()
hit = pygame.transform.smoothscale(hit,(150,150))
stand = pygame.image.load("images - Copy/stand-sign.png").convert_alpha()
